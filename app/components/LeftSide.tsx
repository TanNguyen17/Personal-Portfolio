...
const LeftSide = () => {
    return (
        <div className='flex flex-col justify-between h-full gap-8'>
            <Header />
            <motion.div
                className='flex items-center gap-5 mt-auto pt-8'
                variants={fadeUp(0.5)}
                initial="hidden"
                animate="visible"
            >
                <a
                    ...
                    rel="noreferrer"
                >
                    <button className='font-space text-sm font-medium text-navy-blue bg-green px-6 py-2.5 rounded-lg hover:bg-green/80 transition-colors duration-300'>
                        View Resume
                    </button>
                </a>
                <div className="flex items-center gap-1">
                    <a href='https://github.com/TanNguyen17' target='_blank' rel="noreferrer"
                        className='text-lightest-slate/60 hover:text-green p-2 rounded-lg hover:bg-white/5 transition-all duration-300'>
